...
#	frame4.to_csv(args.o+"/"+project_name+'_frame4.csv', sep="\t")
	...
	counts.drop(counts.tail(1).index,inplace=True)
#	counts = counts.T
	counts.to_csv(args.o+"/a_"+project_name+'_counts.csv', sep="\t")

#	counts_temp = counts
#	counts_temp = counts_temp.drop('genome_length')
...
#		counts_temp = counts_temp[sorted_list]
...
#		counts_temp = counts_temp.reindex(sorted_list_y)
#	else:
#		pass

#	counts_temp.to_csv(args.o+"/"+project_name+'_counts.csv', sep="\t")
